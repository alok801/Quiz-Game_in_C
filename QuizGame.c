...
game:
     ...
     switch(r)
        ...
        case 5:
		printf("\n\n\nIn Who is the father of computer?");
		printf("\n\nA. barbara liskov\t\tB.cberners \n\nC.charles babbage\t\tD. lady augsta");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");countr++;getch(); break;}
		else
		       {
		           printf("\n\nWrong!!! The correct answer is C charles babbage");
		       getch();
		       goto score;
		       break;
		       }
